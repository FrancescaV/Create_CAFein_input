---
title: "07/09/2015 Checking CAFein's input model non-degenerate:"
...
setwd("/Users/francesca/Northwestern/Research/create_models_input_CAFein/FromMESA_fixedUnitsIn_04022013")
filename = "output/ZAMS/zams_1p525Msun_Z0p028_WASP-71/MESAtoCAFein_log211_1p525Msun_Z0p028_deltaX5eM5in_12262013.dat"
...
names(dat) <- c("m","logrho","logP","logT","r","Vg","Astar","U","c1","N2","L2overllp1","g","Lr","V","del_ad","del","Cp","v_t","kappa_s","eps_ad","eps_s","c2","c3","c4","dlnLr_dlnr","P_scale","StartRadSurfLayer","EndRadSurfLayer","Gamma1","entropy","kappa","chiRho","chiT","UoverUsurf")
