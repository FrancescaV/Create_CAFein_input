...
/************************************************************************************
 *****	This code was written by Francesca Valsecchi on 03/25/13 to modify MESA models.
 *****	The output code is in a format suitable for CAFein.
 *****	 
 *****	The code also adds mesh points to the stellar model trying to keep a distance in r
 *****	between two consecutive mesh points of radiusPrecision.
 *****	
 *****	To set: 
